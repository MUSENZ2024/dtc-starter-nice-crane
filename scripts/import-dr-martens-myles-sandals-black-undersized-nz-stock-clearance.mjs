...
const REPORT_PATH =
  "/Users/mrburns_mac/Documents/Claude/Projects/MUSE/medusa-imports/dr-martens-myles-sandals-black-undersized-nz-stock-clearance-report.json"

const IMAGE_PATHS = [
  "/Users/mrburns_mac/Downloads/IMG_8584.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8585.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8586.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8588.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8589.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8590.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8592.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8587.jpeg",
]
...
const IDS = {
  ...
  modelTag: "ptag_01KVMXXMM07PPNSRZ9S7V5HANB", // model:dr-martens-myles
...
// Reference only - never written to. This preserves the established Arizona EU size run,
 ...
 // represents the physically verified undersized NZ Stock clearance batch.
const REFERENCE_PRODUCT_ID = "prod_01KVMWM4BVVZDXGK3SB16SSJFK"

const TITLE = "Dr. Martens Myles Sandals - Black"
const HANDLE = "dr-martens-myles-sandals-black-undersized-nz-stock-clearance"
const EXTERNAL_ID = "NZSTOCK-CLEARANCE-DRMARTENS-MYLES-BLACK-UNDERSIZED"
const PRICE = 80
...
const DESCRIPTION = `IMPORTANT SIZING NOTICE: This clearance batch runs approximately two EU sizes smaller than the labelled size. Please choose carefully before ordering.

Dr. Martens Myles Sandals - Black feature a two-strap slide silhouette with adjustable branded buckles, black uppers, signature yellow welt stitching and a lightweight ripple sole.
...
console.log(`Would create ${TITLE} (clearance) with ${SIZES.length} EU sizes, stock held in sizes 38 (3), 40 (1), and 41 (2), with ${IMAGE_PATHS.length} images in the supplied order.`)
...
const payload = {
  title: TITLE,
  subtitle: "Clearance - Runs About 2 Sizes Small - Final Sale, No Refunds",
  handle: HANDLE,
  ...
  variants: SIZES.map((size) => ({
    title: size,
    sku: `MUSE-NZ-DRMARTENS-MYLES-BLACK-UNDERSIZED-CLR-${size}`.replace(/[^A-Z0-9]/gi, "").toUpperCase(),
    ...
    metadata: {
      ...
      availability_note: STOCK_BY_SIZE[size] ? `NZ stock - clearance, ${STOCK_BY_SIZE[size]} unit(s)` : "Out of stock",
    },
  })),
  ...
  metadata: {
    ...
    catalogue_note: "Separate NZ Stock clearance listing. Existing Dr. Martens Myles product was preserved.",
    fit_summary: "Runs approximately two EU sizes small",
    fit_warning: "This batch is approximately two EU sizes smaller than the labelled size. Choose carefully.",
    sizing_exception: "undersized_by_approximately_2_eu_sizes",
    exchange_policy_note: "No refunds or exchanges - final sale",
    ...
    seo_title: "Dr. Martens Myles Sandals - Black | Clearance NZ Stock | MUSE",
    meta_description: "Clearance Dr. Martens Myles Sandals in Black. NZ Stock EU sizes 38, 40 and 41, $80 final sale. This batch runs approximately two EU sizes small.",
  },
}
