...
const REPORT_PATH =
  "/Users/mrburns_mac/Documents/Claude/Projects/MUSE/medusa-imports/birkenstock-arizona-soft-footbed-suede-mocha-nz-stock-clearance-report.json"

const IMAGE_PATHS = [
  "/Users/mrburns_mac/Downloads/IMG_8327.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8336.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8328.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8329.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8330.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8331.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8332.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8333.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8334.jpeg",
  "/Users/mrburns_mac/Downloads/IMG_8335.jpeg",
]
...
// Reference only - never written to. This preserves the established Arizona EU size run,
 ...
 // represents the physically verified soft-footbed suede pair.
const REFERENCE_PRODUCT_ID = "prod_01KVMXFJCW4KF6RNDZT8YK0EH6"

const TITLE = "Birkenstock Arizona Soft Footbed Suede - Mocha"
const HANDLE = "birkenstock-arizona-soft-footbed-suede-mocha-eu39-nz-stock-clearance"
const EXTERNAL_ID = "NZSTOCK-CLEARANCE-BIRKENSTOCK-ARIZONA-SFB-SUEDE-MOCHA-39"
const PRICE = 100
...
const DESCRIPTION = `Birkenstock Arizona Soft Footbed Suede - Mocha brings Birkenstock's classic two-strap silhouette in a rich mocha brown colourway.

The soft suede upper features two individually adjustable straps with metal pin buckles, allowing the fit to be tuned across the foot.
...
console.log(`Would create ${TITLE} (clearance) with ${SIZES.length} EU sizes, stock held only in size 39, with ${IMAGE_PATHS.length} images in the supplied order.`)
...
const payload = {
  ...
  variants: SIZES.map((size) => ({
    title: size,
    sku: `MUSE-NZ-BIRK-ARIZONA-MOCHA-SFB-CLR-${size}`.replace(/[^A-Z0-9]/gi, "").toUpperCase(),
  ...
  metadata: {
    ...
    catalogue_note: "Separate NZ Stock clearance listing. Existing Arizona Mocha and Mocha Leather products were preserved.",
    ...
    seo_title: "Birkenstock Arizona Soft Footbed Suede - Mocha | Clearance NZ Stock | MUSE",
    meta_description: "Clearance Birkenstock Arizona Soft Footbed Suede in Mocha. NZ Stock, EU size 39, $100 final sale. Adjustable double straps and cushioned soft footbed.",
  },
}
