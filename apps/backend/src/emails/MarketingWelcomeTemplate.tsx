...
const copy: Record<string, { eyebrow: string; heading: string; body: string; cta: string }> = {
  ...
  welcome_last_chance: { eyebrow: "EXPIRY REMINDER", heading: "Your welcome code expires tonight.", body: "This is the final reminder before the real expiry time below. There is no rolling or fake countdown.", cta: "USE MY CODE" },
}
...
export const WelcomeOfferDeliveryTemplate = (props: Omit<WelcomeEmailProps, "templateKey">) => <MarketingWelcomeTemplate {...props} templateKey="welcome_offer_delivery" />
export const WelcomeTrustTemplate = (props: Omit<WelcomeEmailProps, "templateKey">) => <MarketingWelcomeTemplate {...props} templateKey="welcome_trust" />
export const WelcomeDiscoveryTemplate = (props: Omit<WelcomeEmailProps, "templateKey">) => <MarketingWelcomeTemplate {...props} templateKey="welcome_discovery" />
...
export const WelcomeLastChanceTemplate = (props: Omit<WelcomeEmailProps, "templateKey">) => <MarketingWelcomeTemplate {...props} templateKey="welcome_last_chance" />
