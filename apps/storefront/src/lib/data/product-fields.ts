export const PRODUCT_LIST_FIELDS =
  "id,title,handle,status,subtitle,thumbnail,*collection,*categories,*type,*options,*variants.options,*variants.calculated_price,+variants.inventory_quantity,+variants.manage_inventory,+variants.allow_backorder,+variants.metadata,+metadata,*tags"
