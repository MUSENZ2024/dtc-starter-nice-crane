  ...
  return (
    <header className="bg-muse-black px-5 py-5 small:px-8">
      <div className="mx-auto flex max-w-[1200px] items-center justify-between">
        <LocalizedClientLink
          href="/cart"
          className="flex min-h-11 items-center gap-1.5 text-[12.5px] font-medium text-white/65 transition hover:text-muse-cream"
        >
          ← Back to bag
        </LocalizedClientLink>
        ...
        <div className="flex min-h-11 items-center gap-1.5 text-[12px] font-medium text-white/65">
